...
//var User5 = new UserEmployeeInMemory("Roman", "Pyć", 40);


User4.PointAdded += User4PointAddedToFile; //event
//User4.PointAdded += User4PointAddedToFile;
//User4.PointAdded += User4PointAddedTomemory;
void User4PointAddedToFile(object sender, EventArgs args)
{
    Console.WriteLine("dodano ocenę do pliku ");
}
void User4PointAddedTomemory(object sender, EventArgs args)
{
    Console.WriteLine("dodano ocenę do listy ");
}
...
var stat1= User4.GetStat();
    ...
    Console.WriteLine("number of line in file is: " + stat1.Count);
